...
public:
	...
	void loadAssets()
	{
		textureColorMap.loadFromFile(getAssetPath() + "textures/sexyBird.ktx", VK_FORMAT_R8G8B8A8_UNORM, vulkanDevice, queue, VK_IMAGE_USAGE_SAMPLED_BIT | VK_IMAGE_USAGE_STORAGE_BIT, VK_IMAGE_LAYOUT_GENERAL);
