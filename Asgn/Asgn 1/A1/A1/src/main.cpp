...
//	//{
//	//	if (i % nRowPoints == 0) std::cout << '\n';
//	//	printf("%5.2f ", h_DataOutCPU[i]);
//	//}
//	//return 0;
//
//	sdkStopTimer(&hTimer);
...
//		for (uint i{}; i < count; ++i)
//		{
//			if (i % nRowPoints == 0) cpu << '\n';
//			//printf("%5.2f ", h_DataOutCPU[i]);
//			cpu.width(5);
//			cpu << std::fixed << std::setprecision(2) << h_DataOutCPU[i] << ' ';
//		}
//		cpu.close();
//
...
//		for (uint i{}; i < count; ++i)
//		{
//			if (i % nRowPoints == 0) gpu << '\n';
//			//printf("%5.2f ", h_DataGPU[i]);
//			gpu.width(5);
//			gpu << std::fixed << std::setprecision(2) << h_DataGPU[i] << ' ';
//		}
//		gpu.close();
//	}
//	
