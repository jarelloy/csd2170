...
* 
* Co-author Derwin Yan
* Notable modifications:
*   - VulkanExample ctor
*       - Set camera rotation to 0 by default
*       - Adjusted camera position
*   - loadAssets()
*       - commented function body, no assets need to be loaded
*   - buildCommandBuffer()
*       - changed drawing from draw plane to just draw a single vertex
*       - adjusted viewport logic
*   - setupDescriptorPool()
*       - removed texture descriptor
*   - preparePipeline()
*       - modified pVertexInputState
*
* This code is licensed under the MIT license (MIT) (http://opensource.org/licenses/MIT)
*/
